---
title: "Forest biomass mapping based on mean top-of-canopy height"
author:
- name: <br>Viet Nguyen
...
output:
  html_document:
    df_print: paged
subtitle: 'The study aims to create a forest biomass map in Eberswalde, Germany based on mean top-of-canopy height (TCH) raster model. In the first step, a point cloud of Traunstein forest and inventory data were used to derive TCH-to-biomass relationship in Traunstein forest. We assume that the TCH-to-biomass relationship in Traunstein forest is similar with that of Eberswalde forest. With this assumption, in the second step, using the Traunstein TCH-to-biomass relationship to predict or map biomass in Eberswalde.'
---

\

> 🛈 Information: This project was hosted at [GitHub](https://github.com/VietDucNg/biomass-from_TCH).

> 💾 Data:
> [Eberswalde forest point cloud](https://github.com/VietDucNg/biomass-from_TCH/blob/main/data/Eberswalde/419500_5853000.laz)\
> [Traunstein forest point cloud](https://github.com/VietDucNg/biomass-from_TCH/blob/main/data/Traunstein/Subplot_PointCloud_Transformed.rds)\
> [Traunstein forest inventory](https://github.com/VietDucNg/biomass-from_TCH/blob/main/data/Traunstein/Subplot_Inventory.rds)
...
```{r include=FALSE}
inv.df = readRDS('workspace/inv_df.rds')
```
